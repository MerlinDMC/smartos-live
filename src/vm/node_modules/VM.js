...
function buildNicZonecfg(vmobj, payload)
{
    ...
    for (nic in add) {
        ...
        if (nic.hasOwnProperty('limit_maxbw') && nic.limit_maxbw >= 0) {
            zcfg = zcfg + 'add property (name=limit_maxbw, value="'
                + nic.limit_maxbw + '")\n';
        }
